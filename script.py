...
{{
  ...
  "comments": "Комментарии, подзадачи, уточнения — всё полезное для исполнителя. Кратко. Но ничего от себя не добавляй - только информация из команды."
}}
...
Формат ответа — только один JSON:
{{"matched_rows": [4], "changes": {{"Заголовок": "Изменение"}}}}
Только JSON, без markdown и пояснений."""
        ...
        return {"matched_rows": matched, "changes": changes}
